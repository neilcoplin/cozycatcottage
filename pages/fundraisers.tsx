        ...
        <Container fluid="true" id="fundraisers">
          <Stack gap={3} className="top-padding">
            <Container fluid="md" className="center">
              ...
              <p>Your attendance and support help us continue our mission to save lives and protect the journeys of felines throughout Central Ohio. Stay up to date with the latest events and fundraisers by joining our email list.</p>
            ...
            <Container fluid="lg">
              <Row xs={1} sm={2}>
                <Col sm={12} md={8}>
                  ...
                  <p>Just like Santa, the Easter Bunny is ready to pose with your pet. Prints and digital files are available for immediate purchase and 100% of all proceeds benefit Cozy Cat Cottage. Check out our <a href="https://www.facebook.com/cozycatcottage" target="_blank" rel="noreferrer">Facebook page</a> or join our email list to keep up with the Easter Bunny&apos;s schedule. All pets are welcome.</p>

                  <h2>Festivals, Halloween, Valentine&apos;s Day parties and more</h2>
                  <p>Cozy Cat Cottage exhibits at local festivals and hosts a variety of other parties at the shelter. Check out our <a href="https://www.facebook.com/cozycatcottage" target="_blank" rel="noreferrer">Facebook page</a> or join our email list to keep up-to-date!</p>
                </Col>
                <Col sm={12} md={4}>
                  <figure>
